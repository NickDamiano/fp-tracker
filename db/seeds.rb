...
employees = Employee.create([
	# { first_name: 'not in the system', last_name: 'none', location: 'none', in_country: false, permanent: true},
	{ first_name: 'twilio_app', last_name: "twilio_app", phone_num1: twilio_number, 
	phone_num2:  twilio_test_number},
	{ first_name: 'nick', last_name: 'damiano',  phone_num1: "+15129605956", location: 'outer rim', 
